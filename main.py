...
def order():
    ...
    c.drawRightString(width - 2*cm, y, reshape_text(f"جمع کل: {total} تومان"))
     c.drawRightString(width - 2*cm, y, reshape_text(f"بانک سامان - آزیتا فتوحی مظفرنژاد 6219-8610-6509-3089 IR440560083280078294010001
واریز وجه تنها به شماره کارت های دریافتی از شماره تماس 09128883343 دارای اعتبار می باشد. همکار گرامی تنها پس از تایید وجه در بانک مقصد، امکان خروجی از انبار میسر است.
